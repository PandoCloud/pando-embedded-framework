...
struct net_tcp_addr {
    char ip[16];
    uint16 port;
    bool b_use_ssl; //whether to use ssl.
};

typedef void (* net_tcp_connected_callback)(sint8_t errno);
typedef void (* net_tcp_sent_callback)(sint8_t errno);
typedef void (* net_tcp_recv_callback)(struct sys_buf);
typedef void (* net_tcp_disconnected_callback)(sint8_t errno);
typedef void (* net_tcp_server_recv_callback)(int fd, struct sys_buf);
typedef void (* net_tcp_accepted_callback)(int fd, struct net_tcp_addr);
typedef void (* net_tcp_server_sent_callback)(sint8_t fd, sint8_t errno);
typedef void (* net_tcp_server_disconnected_callback)(sint8_t fd, sint8_t errno);
 ...
 * Returns      : none
*******************************************************************************/
void net_tcp_register_connected_callback(net_tcp_connected_callback connected_cb);
 ...
 * Returns      : none
*******************************************************************************/
void net_tcp_register_sent_callback(net_tcp_sent_callback sent_cb);
 ...
 * Returns      : none
*******************************************************************************/
void net_tcp_register_recv_callback(net_tcp_recv_callback recv_cb);
 ...
 * Returns      : none
*******************************************************************************/
void net_tcp_register_disconnected_callback(net_tcp_disconnected_callback disconnected_cb);
...
/******************************************************************************
 * FunctionName : net_tcp_server_register_accepted_callback
 ...
 * Returns      : none.
*******************************************************************************/
void net_tcp_server_register_accepted_callback(net_tcp_accepted_callback accept_cb);

/******************************************************************************
 * FunctionName : net_tcp_server_register_recv_callback
 * Description  : it is used to specify the function that should be called when received package.
 * Parameters   : recv_cb: the specify function.
 * Returns      : the listen result.
*******************************************************************************/
void net_tcp_server_register_recv_callback(net_tcp_server_recv_callback recv_cb);

/******************************************************************************
 * FunctionName : net_tcp_server_send
 * Description  : The tcp send function.
 * Parameters   : fd: the specify descriptor.
 *                buf: the send buffer.
 * Returns      : none
*******************************************************************************/
void net_tcp_server_send(int fd, struct sys_buf buf);

/******************************************************************************
 * FunctionName : net_tcp_server_register_sent_callback
 * Description  : it is used to specify the function that should be called when sent.
 * Parameters   : connected_cb: the specify function.
 * Returns      : none
*******************************************************************************/
void net_tcp_server_register_sent_callback(net_tcp_server_sent_callback sent_cb);
 ...
 * Returns      : none
*******************************************************************************/
void net_tcp_server_register_disconnected_callback(net_tcp_server_disconnected_callback disconnected_cb);
